...
For modern game versions, these libraries can be found in `Superliminal_Data/Managed/`. For legacy (IL2CPP) versions, use the libraries generated by BepInEx (found at `BepInEx/interop/`).
